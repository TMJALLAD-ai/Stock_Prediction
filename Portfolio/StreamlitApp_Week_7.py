...
MODEL_INFO = {
        ...
        "keys": ["APPL", "MPR"],
        "inputs": [{"name": k, "type": "number", "min": 0.0, "default": 0.0, "step": 10.0} for k in ["APPL", "MPR"]]
}
...
def call_model_api(input_df):
    ...
    try:
        ...
        return mapping.get(pred._val, pred_val), 200
...
def display_explanation(input_df, session, aws_bucket):
    ...
    input_df_transformed = preprocessing_pipeline.transform(X_test)
